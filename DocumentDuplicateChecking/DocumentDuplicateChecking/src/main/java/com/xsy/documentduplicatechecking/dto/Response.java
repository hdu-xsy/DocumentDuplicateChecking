package com.xsy.documentduplicatechecking.dto;
...
public class Response<T> implements Serializable {
    private static final long serialVersionUID = -2807807799629567830L;
    ...
    public static <R> Response<R> ok(String str) {
        return new Response<R>(0, null, str);
    }
